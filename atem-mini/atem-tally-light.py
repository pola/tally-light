# Heavily based on work found here:
# https://github.com/filiphanes/PyATEM
...
class Atem:
    ...
    def recvTlIn(self, data):
        ...
        if self.tallyHandler is not None:
    ...
    def dump(self):
        pprint.pprint(self.system_config)
        pprint.pprint(self.status)
        pprint.pprint(self.state)
        pprint.pprint(self.cameracontrol)
